# Reproduce Table 4 (main table only) using reusable functions
# -------------------------------------------------------------
# Run:
#   Rscript -e 'devtools::load_all(); source("inst/examples/reproduce_table4_main.R")'
...
run_case <- function(criteria, q_cost, n_vals = NULL, C_vals = NULL) {
  ...
  print("=======================================================")
  print(paste("Table 4 block:", paste(criteria, collapse = "-"), "q =", q_cost))
...
# Table 4 main rows
run_case(criteria = c("D", "A"), q_cost = 0.0, n_vals = c(10L, 25L, 50L))
run_case(criteria = c("D", "A", "Ds"), q_cost = 0.0, n_vals = c(10L, 25L, 50L))
run_case(criteria = c("D", "A"), q_cost = 0.2, C_vals = c(100L, 500L))
run_case(criteria = c("D", "A", "Ds"), q_cost = 0.2, C_vals = c(100L, 500L))

print("Done: Table 4 main table reproduction.")
