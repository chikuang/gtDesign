# Reproduce Table 8 (fixed assays/tests) — same layout as Table 7
# ----------------------------------------------------------------
# Chlamydia: theta = (0.022, 0.92, 0.965), M = 15, q = 0, fixed test count C_tests.
# If your PDF’s Table 8 uses different C_tests or q_cost, edit below (same pattern as
# `inst/paper_reproduce/table7.R`).
#
# Run:
#   Rscript -e 'devtools::load_all(); source("inst/paper_reproduce/table8.R")'
...
print("Table 8 final output:")
if (requireNamespace("knitr", quietly = TRUE)) {
  print(knitr::kable(table8, format = "pipe"))
} else {
